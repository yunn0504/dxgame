...
bool GraphicsClass::Initialize(int screenWidth, int screenHeight, HWND hwnd)
{
	...
	result = m_Model->Initialize(m_D3D->GetDevice(),"model.txt",L"robotcolor.png");
	if(!result)
	{
	...
	m_Light->SetDirection(-2.0f, 0.0f, -0.5f);
...
bool GraphicsClass::Render(float rotation)
{
	...
	m_Camera->SetPosition(0, 100, 200);
	m_Camera->Render();
